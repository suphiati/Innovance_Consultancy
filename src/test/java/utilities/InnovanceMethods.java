...
public class InnovanceMethods {
    ...
    public static void yeniSayfaSosyalMedya(String baseUrl, String expectedUrlPart) {
        ...
        String expectedUrlIcerik = expectedUrlPart;
    ...
    public static void innovanceMethodYoutube(){
        yeniSayfaSosyalMedya("https://innovance.com.tr/","youtube");
        bekle(2);
    }
    public static void innovanceMethodInstagram(){
        yeniSayfaSosyalMedya("https://innovance.com.tr/","instagram");
        bekle(2);
    }

    public static void innovanceMethodMedium(){
        yeniSayfaSosyalMedya("https://innovance.com.tr/","medium");
        bekle(2);
    }
    public static void innovanceMethodTwitter(){
        yeniSayfaSosyalMedya("https://innovance.com.tr/","twitter");
        bekle(2);
